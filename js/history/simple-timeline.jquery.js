            ...
            if (newDate === $this.data("date")) {
              ...
              $('.eventButton').each(function() {
                if('d' + newDate  ===  $(this).attr('id')) {
                  $(this).children( ".blob" ).animate({"backgroundColor": "#3498db"}, 200);
                }
          ...
          $('.eventButton').on({
            ...
            mouseenter: function(e) {
              ...
              self.options.content.each(function() {
                ...
                if (dateId === $this.data("date")) {
                  ...
                  blob.animate({backgroundColor: "#3498db"}, 300);
            ...
            mouseleave: function(e) {
              ...
              blob.animate({backgroundColor: "#9e9e9e" }, 200);
                ...
                blob.animate({backgroundColor: "#3498db"}, 200);
              }
            },
            ...
            click: function(e) {
              ...
              blob.css({backgroundColor: "#3498db" });
